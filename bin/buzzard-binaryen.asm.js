Module["asm"] =  (function(global,env,buffer) {
 ...
 var ga = env._pthread_cleanup_push;
...
function pb(a) {
 ...
 do if (a >>> 0 < 245) {
  ...
  if (b & 3 | 0) {
   ...
   g = f + 8 | 0;
   h = c[g >> 2] | 0;
   do if ((d | 0) == (h | 0)) c[20963] = k & ~(1 << b); else {
    if (h >>> 0 < (c[20967] | 0) >>> 0) _();
    a = h + 12 | 0;
    if ((c[a >> 2] | 0) == (f | 0)) {
     c[a >> 2] = d;
     c[e >> 2] = h;
  ...
  if (q >>> 0 > h >>> 0) {
   ...
   if (a) {
    ...
    do if (h | 0) {
     ...
     a = c[k + 20 >> 2] | 0;
     if (a | 0) if (a >>> 0 < (c[20967] | 0) >>> 0) _(); else {
      c[o + 20 >> 2] = a;
      c[a + 24 >> 2] = o;
      break;
     }
  ...
  if (k) {
   ...
   if (k) if (h >>> 0 < ((c[20965] | 0) - q | 0) >>> 0) {
    ...
    do if (h >>> 0 < 16) {
     ...
     if ((w | 0) == 145) if (b >>> 0 < (c[20967] | 0) >>> 0) _(); else {
      c[b >> 2] = j;
      c[j + 24 >> 2] = a;
      c[j + 12 >> 2] = j;
      c[j + 8 >> 2] = j;
 ...
 if ((w | 0) == 191) {
  a = (c[21071] | 0) + h | 0;
  c[21071] = a;
  if (a >>> 0 > (c[21072] | 0) >>> 0) c[21072] = a;
  j = c[20969] | 0;
  do if (!j) {
   C = c[20967] | 0;
   if ((C | 0) == 0 | f >>> 0 < C >>> 0) c[20967] = f;
   c[21075] = f;
   c[21076] = h;
   c[21078] = 0;
   c[20972] = c[21081];
   ...
   if ((w | 0) == 209) if (!(c[a + 12 >> 2] & 8)) {
    ...
    do if ((a | 0) == (j | 0)) {
     ...
     if ((w | 0) == 276) if (b >>> 0 < (c[20967] | 0) >>> 0) _(); else {
      c[b >> 2] = l;
      c[l + 24 >> 2] = a;
      c[l + 12 >> 2] = l;
      c[l + 8 >> 2] = l;
   ...
   if ((d | 0) != (j | 0)) {
    ...
    if ((w | 0) == 302) if (b >>> 0 < (c[20967] | 0) >>> 0) _(); else {
     c[b >> 2] = j;
     c[j + 24 >> 2] = a;
     c[j + 12 >> 2] = j;
     c[j + 8 >> 2] = j;
  ...
  default:
   {
    ...
    d : do if (!e) {
     e = 0;
     do {
      if ((h | 32 | 0) != (a[81782 + e >> 0] | 0)) break d;
      do if (e >>> 0 < 2) {
       h = c[F >> 2] | 0;
       if (h >>> 0 < (c[D >> 2] | 0) >>> 0) {
        c[F >> 2] = h + 1;
    ...
    case 0:
     {
      do if ((h | 0) == 48) {
       ...
       e = vb(32, 0, J | 0, ((J | 0) < 0) << 31 >> 31 | 0) | 0;
       e = wb(l | 0, h | 0, e | 0, C | 0) | 0;
       J = C;
      ...
      do if ((z | 0) == 172) {
       ...
       if ((o | 0) < 9) if ((o | 0) <= (h | 0) & (h | 0) < 18) {
        ...
        if ((h | 0) < 9) {
         g = +(K | 0) * +((c[I >> 2] | 0) >>> 0) / +(c[81472 + (8 - h << 2) >> 2] | 0);
         break;
        }
        b = L + 27 + (R(h, -3) | 0) | 0;
        e = c[I >> 2] | 0;
        if ((b | 0) > 30 | (e >>> b | 0) == 0) {
         g = +(K | 0) * +(e >>> 0) * +(c[81472 + (h + -10 << 2) >> 2] | 0);
         break;
        }
       }
       e = (h | 0) % 9 | 0;
       ...
       i : while (1) {
        ...
        do {
         ...
         while (1) {
          ...
          p = I + (t << 2) | 0;
          o = zb(c[p >> 2] | 0, 0, 29) | 0;
          o = wb(o | 0, C | 0, n | 0, 0) | 0;
          n = C;
          if (n >>> 0 > 0 | (n | 0) == 0 & o >>> 0 > 1e9) {
           b = Db(o | 0, n | 0, 1e9, 0) | 0;
           o = Eb(o | 0, n | 0, 1e9, 0) | 0;
           n = b;
          } else n = 0;
          c[p >> 2] = o;
          b = (t | 0) == (k | 0);
       ...
       o = t ? ((p | 0) < 0 ? 0 : p) : L;
       if ((o | 0) < 53) {
        N = +Qa(+Ma(1.0, 105 - o | 0), j);
        m = +Ra(j, +Ma(1.0, 53 - o | 0));
        q = N;
        g = m;
        m = N + (j - m);
       } else {
...
function Ya(e, f, j) {
 ...
 K = P;
 y = P + 32 | 0;
 if ((c[e + 76 >> 2] | 0) > -1) O = Ta(e) | 0; else O = 0;
 k = a[f >> 0] | 0;
 a : do if (!(k << 24 >> 24)) k = 0; else {
  ...
  b : while (1) {
   c : do if (!(Za(m & 255) | 0)) {
    ...
    while (1) {
     m = n + 1 | 0;
     if (!(Za(d[m >> 0] | 0) | 0)) break; else n = m;
    }
    _a(e, 0);
    do {
     m = c[L >> 2] | 0;
...
function qb(a) {
 ...
 do if (!(a & 1)) {
  ...
  if (!f) {
   ...
   if (!a) {
    q = k;
    g = j;
   } else if (a >>> 0 < (c[20967] | 0) >>> 0) _(); else {
    c[i + 20 >> 2] = a;
    c[a + 24 >> 2] = i;
    q = k;
    g = j;
 ...
 do if (!(a & b)) {
  ...
  if ((e | 0) == 127) if (b >>> 0 < (c[20967] | 0) >>> 0) _(); else {
   c[b >> 2] = q;
   c[q + 24 >> 2] = a;
   c[q + 12 >> 2] = q;
   c[q + 8 >> 2] = q;
 ...
 do if (!(d & 1)) {
  ...
  if (!f) {
   ...
   if (!d) {
    r = l;
    g = k;
   } else if (d >>> 0 < (c[20967] | 0) >>> 0) _(); else {
    c[j + 20 >> 2] = d;
    c[d + 24 >> 2] = j;
    r = l;
    g = k;
 ...
 if (!(a & 2)) {
  ...
  do if (a >>> 0 < 256) {
   ...
   if (f | 0) {
    ...
    d = c[d + 4 >> 2] | 0;
    if (d | 0) if (d >>> 0 < (c[20967] | 0) >>> 0) _(); else {
     c[n + 20 >> 2] = d;
     c[d + 24 >> 2] = n;
     break;
    }
...
function cb(b, e, f, g, h) {
 ...
 a : do if (e >>> 0 > 36) {
  ...
  do if ((e | 16 | 0) == 16 & (i | 0) == 48) {
   ...
   e = j ? 10 : e;
   if ((d[81508 + i >> 0] | 0) >>> 0 < e >>> 0) n = 32; else {
  ...
  if ((n | 0) == 72) if ((d[81508 + i >> 0] | 0) >>> 0 < e >>> 0) {
   do {
    i = c[r >> 2] | 0;
    if (i >>> 0 < (c[q >> 2] | 0) >>> 0) {
     c[r >> 2] = i + 1;
...
function sb(a, b) {
 ...
 if (!e) {
  ...
  if (d >>> 0 >= (b + 4 | 0) >>> 0) if ((d - b | 0) >>> 0 <= c[21083] << 1 >>> 0) return a | 0;
  a = 0;
  return a | 0;
 }
 if (d >>> 0 >= b >>> 0) {
...
function Aa(a) {
 ...
 a : while (1) {
  ...
  a = c[20256] | 0;
  if (gb(84348, 84348 + (c[1024 + (a + 1 << 2) >> 2] | 0) | 0) | 0) do a = c[1024 + (a << 2) >> 2] | 0; while ((gb(84348, 84348 + (c[1024 + (a + 1 << 2) >> 2] | 0) | 0) | 0) != 0);
  if ((a | 0) == 1) {
   d = 8;
   break;
  } else a = a + 2 | 0;
 ...
 case 10:
  {
   c[20449] = c[81800 + ((c[20447] | 0) - (c[20449] | 0) << 2) >> 2];
   break;
  }
 case 11:
  {
 ...
 case 12:
  {
   d = c[20447] | 0;
   c[20449] = R(c[20449] | 0, c[81800 + (d << 2) >> 2] | 0) | 0;
   c[20447] = d + -1;
   break;
  }
 case 13:
  {
   d = c[20447] | 0;
   c[1024 + (c[20449] << 2) >> 2] = c[81800 + (d << 2) >> 2];
   c[20449] = c[81800 + (d + -1 << 2) >> 2];
   c[20447] = d + -2;
   break;
  }
 case 14:
  {
   d = (c[20447] | 0) + 1 | 0;
   c[20447] = d;
   c[81800 + (d << 2) >> 2] = c[20449];
   d = c[20448] | 0;
   c[20449] = c[1024 + (d << 2) >> 2];
   c[20448] = d + 1;
   break;
  }
 case 15:
  {
   d = c[20447] | 0;
   c[20449] = (c[81800 + (d << 2) >> 2] | 0) - (c[20449] | 0);
   c[20447] = d + -1;
   break;
  }
 case 16:
  {
   d = (c[257] | 0) + 1 | 0;
   c[257] = d;
   c[1024 + (d << 2) >> 2] = c[20448];
   c[20448] = a + 1;
   break;
  }
 case 17:
  {
   c[20449] = (c[20449] | 0) >>> 31;
   break;
  }
 case 18:
  {
 ...
 case 19:
  {
   c[20449] = c[1024 + (c[20449] << 2) >> 2];
   break;
  }
 case 20:
  {
   d = c[20447] | 0;
   c[20449] = (c[81800 + (d << 2) >> 2] | 0) / (c[20449] | 0) | 0;
   c[20447] = d + -1;
   break;
  }
 case 21:
 ...
 a : do if ((i | 0) == 0 & (l | 0) == 0) q = 3; else {
  ...
  if (g >>> 0 > 2146435072 | (g | 0) == 2146435072 & (c[k >> 2] | 0) >>> 0 > 0 | (e | 0) == 2047) q = 3; else {
   ...
   if (!j) {
    ...
    n = zb(n | 0, o | 0, 1 - j | 0) | 0;
    m = C;
   } else m = o & 1048575 | 1048576;
   l = vb(d | 0, f | 0, n | 0, m | 0) | 0;
   i = C;
   ...
   if ((e | 0) > 0) {
    o = wb(d | 0, f | 0, 0, -1048576) | 0;
    d = C;
    e = zb(e | 0, 0, 52) | 0;
    d = d | C;
    e = o | e;
   } else {
    e = yb(d | 0, f | 0, 1 - e | 0) | 0;
    d = C;
   }
   c[k >> 2] = e;
   c[k + 4 >> 2] = d | p;
 ...
 if ((e + -48 | 0) >>> 0 > 9) if (!(c[j >> 2] | 0)) {
  ...
  if ((e + -48 | 0) >>> 0 < 10) {
   do {
    b = Bb(f | 0, b | 0, 10, 0) | 0;
    f = C;
    e = wb(e | 0, ((e | 0) < 0) << 31 >> 31 | 0, -48, -1) | 0;
    f = wb(e | 0, C | 0, b | 0, f | 0) | 0;
    b = C;
    e = c[i >> 2] | 0;
    if (e >>> 0 < (c[j >> 2] | 0) >>> 0) {
     c[i >> 2] = e + 1;
...
function ib(b, d) {
 ...
 d = d | 0;
 var e = 0, f = 0, g = 0;
 if ((c[d + 76 >> 2] | 0) < 0) g = 3; else if (!(Ta(d) | 0)) g = 3; else {
...
function hb(b, e) {
 ...
 do if ((h | 0) == 4) {
  ...
  if ((qa[c[b + 36 >> 2] & 7](b, l, 1) | 0) == 1) f = d[l >> 0] | 0; else f = -1;
 } while (0);
 i = m;
 return f | 0;
}
...
function ob(b) {
 ...
 while (1) {
  c = b + 1 | 0;
  if (!(Za(a[b >> 0] | 0) | 0)) break; else b = c;
 }
 d = a[b >> 0] | 0;
 switch (d << 24 >> 24 | 0) {
 case 45:
...
function Ua(a) {
 ...
 var b = 0, d = 0;
 do if (!a) {
  if (!(c[20287] | 0)) b = 0; else b = Ua(c[20287] | 0) | 0;
  $(83828);
  a = c[20956] | 0;
  if (a) do {
   if ((c[a + 76 >> 2] | 0) > -1) d = Ta(a) | 0; else d = 0;
...
function Va(a) {
 ...
 if ((d | 0) == 3) {
  ...
  d = a + 8 | 0;
  e = c[d >> 2] | 0;
  if (b >>> 0 < e >>> 0) qa[c[a + 40 >> 2] & 7](a, b - e | 0, 1) | 0;
  c[a + 16 >> 2] = 0;
  c[h >> 2] = 0;
  c[g >> 2] = 0;
  c[d >> 2] = 0;
...
function kb(a) {
 a = a | 0;
 var b = 0, e = 0, f = 0;
 if ((c[a + 76 >> 2] | 0) < 0) f = 3; else if (!(Ta(a) | 0)) f = 3; else {
  b = a + 4 | 0;
  e = c[b >> 2] | 0;
  if (e >>> 0 < (c[a + 8 >> 2] | 0) >>> 0) {
   c[b >> 2] = e + 1;
...
function Xa(b) {
 ...
 d = b + 20 | 0;
 e = b + 44 | 0;
 if ((c[d >> 2] | 0) >>> 0 > (c[e >> 2] | 0) >>> 0) qa[c[b + 36 >> 2] & 7](b, 0, 0) | 0;
 c[b + 16 >> 2] = 0;
 c[b + 28 >> 2] = 0;
 c[d >> 2] = 0;
 d = c[b >> 2] | 0;
...
function Wa(a) {
 ...
 i = i + 16 | 0;
 b = f;
 if (!(c[a + 8 >> 2] | 0)) if (!(Xa(a) | 0)) e = 3; else b = -1; else e = 3;
 if ((e | 0) == 3) if ((qa[c[a + 32 >> 2] & 7](a, b, 1) | 0) == 1) b = d[b >> 0] | 0; else b = -1;
 i = f;
 return b | 0;
}
...
function Ea() {
 var a = 0;
 if (!(c[20950] | 0)) a = 83844; else a = c[(Gb() | 0) + 64 >> 2] | 0;
 return a | 0;
}
...
// EMSCRIPTEN_END_FUNCS
 ...
 var pa = [ Kb, Ca ];
 var qa = [ Lb, Ja, Ia, Ka, Fa, Lb, Lb, Lb ];
 var ra = [ Mb, Ga, La, Mb ];
 return {
  ___muldsi3: Ab,
  _i64Subtract: vb,
